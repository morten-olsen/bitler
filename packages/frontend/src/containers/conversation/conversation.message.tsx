...
import { useConversation } from '@bitlerjs/react';
...
type ConversationMessageProps = {
  retry?: () => void;
  remove?: () => void;
  message: ReturnType<typeof useConversation>['messages'][number];
};

const ConversationMessage = ({ message, remove, retry }: ConversationMessageProps) => {
  return (
    <motion.div
    ...
    >
      <div className="flex gap-4 items-start">
        ...
        <div className={clsx({ 'flex-1': message.loading }, 'flex flex-col gap-2')}>
