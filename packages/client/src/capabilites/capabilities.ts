...
type CapabilityInput<TSchema extends ServerSchema, TKind extends keyof TSchema["capabilities"] | string> =
  TKind extends keyof TSchema["capabilities"] ? TSchema["capabilities"][TKind]["input"] : unknown;

type CapabilityOutput<TSchema extends ServerSchema, TKind extends keyof TSchema["capabilities"] | string> =
