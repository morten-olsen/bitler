import { createConnection, createLongLivedTokenAuth, callService, HassEntities, subscribeEntities } from "home-assistant-js-websocket";
...
class HomeassistantService {
  ...
  public callService = async <T = unknown>(options: CallServiceOptions) => {
    ...
    const response = await callService(connection, domain, service, serviceData,
      target ? {
